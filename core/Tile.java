...
public class Tile {
    private HashSet<Amazon> amazonSet;
    private ArrayList<Dinoszaurusz> dinoszauruszList;
    private ArrayList<Item> itemList;
    private BrainDrainer brainDrainer;


    public Tile() {
        this.amazonSet = new HashSet<>();
        this.dinoszauruszList = new ArrayList<>();
